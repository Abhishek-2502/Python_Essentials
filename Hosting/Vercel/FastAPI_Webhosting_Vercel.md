...
5. Select framework as `FastAPI`.
5. Click "Deploy".

## Conclusion
After following these steps, your FastAPI project should be successfully deployed on Vercel. Visit your Vercel dashboard to manage and view your project.
